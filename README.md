...
local Window = OrionLib:MakeWindow({Name = "Ｄｒｅｘ ×͜×", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Ｄｒｅｘ ×͜×"})
